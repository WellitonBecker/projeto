      ...
      <div className="xs:p-0 mx-auto p-10 md:w-full md:max-w-md">
        ...
        <div className="w-full divide-y divide-gray-200 rounded-lg bg-white shadow">
          <div className="px-5 py-7">
            ...
            />
            <div className="mb-5 whitespace-nowrap text-center sm:text-left">
              <a
                className="cursor-pointer rounded-lg  text-sm font-normal"
                href="/resetar_senha"
              >
                <span className="ml-1 inline-block hover:text-blue-600 hover:underline">
                  Forgot Password
                </span>
              </a>
            </div>
